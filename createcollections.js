    ...
    if (!(item.toString().includes("dataset"))) {
        ...
        var csvStream = csv()
            .on("data", function (data) {
                    ...
                    csvData.forEach(function (dat) {
                        ...
                        if (monthItem.monthtitle == clast) {
                            ...
                            if(dat[5]=="-"){
                                ...
                                dat[5] =dat[5].replace(/,/g,"");
                                                        }
                            // console.log(dat[6]);
                            if(dat[6]=="-"){
                                dat[6]="0"
                            }else{
                                dat[6] =dat[6].replace(/,/g,"");
                                // console.log(dat[6]);
                                // var int =parseInt(dat[6]);
                                // console.log(int);
                            }
                ...
                // async.eachSeries(monthsColl.months,function(eachmonth,next){
                                ...
                                mon.dates.forEach(function (dateItem) {
                                    ...
                                    if (mon.monthtitle == monString) {
                                        ...
                                        var date = new CrDate({
                                            ...
                                            volume: parseInt(dateItem.volume),
